    ...
    <Sheet>
      <SheetTrigger asChild>
        <button
          ...
          aria-label={format(day, copy.month.dayLabelFormat, { locale: ptBR })}
          className={cn(
      ...
      <SheetContent className="flex flex-col gap-0">
        <SheetHeader>
          ...
          <SheetDescription className="font-mono text-2xs uppercase tracking-[0.04em] text-muted-foreground">
