    ...
    >
      <a href={path === "/" ? "/" : "/dashboard"} className="inline-flex gap-2 items-center">
        <div className="relative h-7 aspect-square">
          <img
            ...
            alt=""
            className="absolute h-full w-full object-cover invert dark:invert-0"
          />
        </div>

        <h1 className="font-bold text-2xl cursor-pointer">Dailify</h1>
      </a>
      ...
      <div className="inline-flex gap-5 items-center">
        ...
        {user ? (
          ...
          <div className="flex gap-5">
            <Button
              className="bg-foreground hover:text-white text-background hover:bg-primary/70 cursor-pointer"
