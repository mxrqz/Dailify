        ...
        <div className="py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-muted-foreground mx-auto">
              Aumente sua produtividade com recursos premium e desbloqueie todo o potencial do
              Dailify.
            </p>
          </div>
            ...
            {plans.map((plan) => (
              <Card
                ...
                className={`relative overflow-hidden border-2 ${
                  plan.popular ? "border-purple-200 dark:border-purple-900" : "border-border"
              ...
              >
                ...
                <CardHeader>
                  <div className="flex items-center gap-2 mb-2">
                    <div
                      className={`flex h-8 w-8 items-center justify-center rounded-full ${plan.color} text-white`}
                    >
                      {plan.icon}
                    </div>
